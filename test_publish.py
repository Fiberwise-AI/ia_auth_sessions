...
def install_package_dev():
    ...
    print("\n📦 Installing ia-auth-sessions in editable mode with dev dependencies...")
...
def publish_to_testpypi(token=None):
    ...
    if result.returncode == 0:
        ...
        print("   View at: https://test.pypi.org/project/ia-auth-sessions/")
    else:
...
def main():
    ...
    print("🚀 ia-auth-sessions - PyPI Publishing Test")
    print("=" * 60)
